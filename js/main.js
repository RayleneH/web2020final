    ...
    $('.movable').each(function () {
      ...
      if (parent_scrolled >= 0 && scrolled < next_pos - winh) {
        if ($(this).attr('data-top')) {
          $(this).css(
            'top',
            (($(this).data('top2') - $(this).data('top')) * parent_scrolled) / (parent_height - winh) +
              $(this).data('top') +
              '%'
          )
        }
